const steps = [
  {
    ...
    description:
      "Cadastre-se em poucos segundos e monte seu perfil no Rotina Plus.",
  },
  {
    number: "2",
    title: "Adicione suas tarefas",
    description:
      "Liste seus hábitos e tarefas diárias ou semanais com prioridade e prazo.",
  },
  {
    number: "3",
    title: "Ganhe pontos e evolua",
    description:
      "Complete tarefas, acumule pontos e acompanhe sua constância crescer.",
  },
];
