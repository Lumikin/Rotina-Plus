    ...
    >
      ...
      >
        ...
        <div className="d-flex align-items-center gap-2">
          ...
          <a href="/login" className="btn btn-outline-info btn-sm fw-semibold px-3">
            Entrar
          </a>

          <a href="/register" className="btn btn-info text-white btn-sm fw-semibold px-3">
            Cadastrar
          </a>
        </div>
      </header>
          ...
          <div className="card-body p-4 p-md-5">
            ...
            {etapa === 1 ? (
              <form onSubmit={handleEnviarDados}>
                ...
                {successRegister && (
                  <div className="alert alert-success mb-3">{successRegister}</div>
                )} 
